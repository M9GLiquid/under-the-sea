...
Usage:
  python tools/Tool_3_Rectify_Arena_Square.py <corners_json_or_corrected_image>
    ...
    try:
        ...
        if not corners_path.lower().endswith(".json"):
            ...
            if os.path.exists(guessed):
                ...
                print("Run Tool 2 (Tool_2_Detect_Arena_Corners.py) first, or pass the JSON path explicitly.")
                return 1
